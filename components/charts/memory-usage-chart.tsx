...
export function MemoryUsageChart() {
	...
	return (
		<ChartCard
			title='Memory Usage'
			description='Average and P95 memory usage for contract calls'
			timeRange={timeRange}
			...
			<div className='h-[350px] w-full'>
				{chartData.length > 0 ? (
					...
					<EmptyState
						...
						description={`No memory usage data found for the selected time range (${timeRange}). Try selecting a different time range.`}
						action={{
